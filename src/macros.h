...
#define MACRO_32(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, a2, b2, c2, d2, e2, f2) \
  ...
  PAIR(i), PAIR(j), PAIR(k), PAIR(l), PAIR(m), PAIR(n), PAIR(o), PAIR(p), \
  PAIR(q), PAIR(r), PAIR(s), PAIR(t), PAIR(u), PAIR(v), PAIR(w), PAIR(x), \
  PAIR(y), PAIR(z), PAIR(a2), PAIR(b2), PAIR(c2), PAIR(d2), PAIR(e2), PAIR(f2)
...
#define MACRO(...) \
  GET_MACRO(__VA_ARGS__, \
    MACRO_32, MACRO_31, MACRO_30, MACRO_29, MACRO_28, MACRO_27, MACRO_26, MACRO_25, \
    MACRO_24, MACRO_23, MACRO_22, MACRO_21, MACRO_20, MACRO_19, MACRO_18, MACRO_17, \
    MACRO_16, MACRO_15, MACRO_14, MACRO_13, MACRO_12, MACRO_11, MACRO_10, MACRO_9,  \
    MACRO_8,  MACRO_7,  MACRO_6,  MACRO_5,  MACRO_4,  MACRO_3,  MACRO_2,  MACRO_1  \
  )(__VA_ARGS__)
