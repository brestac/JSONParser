...
desktop-test:
	tests/desktop.cpp $(HEADERS) $(CXX) $(CXXFLAGS) -I. tests/desktop.cpp -o desktop-test

desktop-test-debug:
	tests/desktop.cpp $(HEADERS) NIX_HARDENING_ENABLE= $(CXX) $(CXXFLAGS) -O0 -I. tests/desktop.cpp -o desktop-test-debug
